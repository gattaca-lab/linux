...
#define __untagged_addr(addr)	\
	switch ((csr_read(CSR_SATP) >> SATP_ASID_SHIFT)  & SATP_ASID_MASK) { \
	case SATP_MODE_57: \
	addr &= ((__force __typeof__(addr))sign_extend64((__force u64)(addr), 55)); \
	break; \
	case SATP_MODE_48: \
	addr &= ((__force __typeof__(addr))sign_extend64((__force u64)(addr), 47)); \
	break; \
	case SATP_MODE_39: \
	addr &= ((__force __typeof__(addr))sign_extend64((__force u64)(addr), 38)); \
	break; \
	default: \
	addr &= addr; } \
